...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--learning_rate', type=float, default=0.002, help="the learning rate")
    parser.add_argument('-r', '--regularization_rate', type=float, default=0.02, help="the regularization rate")
