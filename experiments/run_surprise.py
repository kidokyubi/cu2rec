...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--learning_rate', type=float, default=0.2, help="the learning rate")
    parser.add_argument('-r', '--regularization_rate', type=float, default=0.1, help="the regularization rate")
